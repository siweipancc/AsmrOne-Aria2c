...
// Root myDeserializedClass = JsonConvert.DeserializeObject<WorkInfo>(myJsonResponse);
public class WorkInfo
{
    ...
    public class TranslationInfo
    {
        ...
        public List<object> child_worknos { get; set; }
        public object parent_workno { get; set; }
        public object original_workno { get; set; }
        public bool is_translation_agree { get; set; }
        public List<object> translation_bonus_langs { get; set; }
